...
async function InitializePopup() {
    ...
    // Exemplo de uso dentro do InitializePopup:
    waitForElement('#updateTasks', (button) => {
    ...
    // document.querySelector('.nav-tab[data-tab="organization"]').addEventListener('click', async () => {
    //     try {
    ...
    */
    ...
    // document.querySelector('.nav-tab[data-tab="repositorys"]').addEventListener('click', async () => {
    //     try {
...
async function initializeAll() {
    await initializeModules(initializeModulePath);
